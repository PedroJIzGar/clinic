...
public class SecurityConfig {
	...
	@Bean
	  SecurityFilterChain securityFilterChain(HttpSecurity http, UserRoleResolver roleResolver) throws Exception {
	    FirebaseAuthFilter firebaseFilter = new FirebaseAuthFilter(roleResolver);
